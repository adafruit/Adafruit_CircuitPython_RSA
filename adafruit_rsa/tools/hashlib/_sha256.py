...
# pylint: disable=bad-whitespace, trailing-whitespace, missing-docstring, too-many-statements
...
def sha_init():
    ...
    sha_info['digest'] = [0x6A09E667, 0xBB67AE85, 0x3C6EF372,
